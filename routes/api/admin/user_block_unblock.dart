...
Future<Response> onRequest(RequestContext context) async {
  ...
  try {
    ...
    final isBlocked = body['isBlocked'] == true || body['block'] == true || body['status'] == 'Blocked';
    ...
    await AdminService.instance.toggleUserBlock(userId, isBlocked: isBlocked, adminId: claims.userId);
