...
Future<Response> onRequest(RequestContext context) async {
  ...
  try {
    ...
    final updated = await AdminRepository.instance.updateProductReportStatus(reportId, status);

    return Response.json(
      body: {'success': updated, 'message': 'Report status updated successfully'},
    );
  } catch (error) {
    return Response.json(
      statusCode: HttpStatus.internalServerError,
      body: {'message': 'Failed to update report', 'error': error.toString()},
    );
  }
}
